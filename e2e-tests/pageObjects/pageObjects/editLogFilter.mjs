...
async function _utam_get_closeIconButton(driver, root) {
    let _element = root;
    const _locator = _By.css("header button.slds-modal__close");
    _element = new _ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_heading(driver, root) {
    let _element = root;
    const _locator = _By.css("h2#modal-heading-01");
    _element = new _ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_filterTextarea(driver, root) {
    let _element = root;
    const _locator = _By.css("lightning-textarea[name='filter']");
    _element = new _ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_closeButton(driver, root) {
    let _element = root;
    const _locator = _By.css("footer button.slds-button_neutral:first-child");
    _element = new _ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_setDefaultButton(driver, root) {
    let _element = root;
    const _locator = _By.css("footer button.slds-button_neutral:nth-child(2)");
    _element = new _ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_saveButton(driver, root) {
    let _element = root;
    const _locator = _By.css("footer button.slds-button_brand");
    _element = new _ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
 ...
 * @author UTAM
 */
export default class EditLogFilter extends _UtamBasePageObject {
