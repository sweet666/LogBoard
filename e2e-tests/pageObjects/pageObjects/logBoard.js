...
var _LogTable = require('utam-lgb/pageObjects/logTable');
var _LogView = require('utam-lgb/pageObjects/logView');
var _LogSearchResult = require('utam-lgb/pageObjects/logSearchResult');
var _EditLogFilter = require('utam-lgb/pageObjects/editLogFilter');

async function _utam_get_spinner(driver, root) {
    let _element = root;
    const _locator = core.By.css("lightning-spinner");
...
async function _utam_get_traceFlagExpiration(driver, root) {
    let _element = root;
    const _locator = core.By.css(".header-block.exparation");
    _element = new core.ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_enableButton(driver, root) {
    let _element = root;
    const _locator = core.By.css("lightning-button[name='EnableLogs']");
    _element = new core.ShadowRoot(driver, _element);
    const hasElement = await _element.containsElement(_locator);
    if (!hasElement) { return null; }
    return _element.findElement(_locator);
...
async function _utam_get_stopButton(driver, root) {
    let _element = root;
    const _locator = core.By.css("lightning-button[name='StopLogs']");
    _element = new core.ShadowRoot(driver, _element);
    const hasElement = await _element.containsElement(_locator);
    if (!hasElement) { return null; }
    return _element.findElement(_locator);
...
async function _utam_get_duration1Button(driver, root) {
    let _element = root;
    const _locator = core.By.css("button[data-id='1']");
    _element = new core.ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_duration2Button(driver, root) {
    let _element = root;
    const _locator = core.By.css("button[data-id='2']");
    _element = new core.ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_duration3Button(driver, root) {
    let _element = root;
    const _locator = core.By.css("button[data-id='3']");
    _element = new core.ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_duration5Button(driver, root) {
    let _element = root;
    const _locator = core.By.css("button[data-id='5']");
    _element = new core.ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_duration10Button(driver, root) {
    let _element = root;
    const _locator = core.By.css("button[data-id='10']");
    _element = new core.ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_deleteLogsButton(driver, root) {
    let _element = root;
    const _locator = core.By.css("lightning-button-icon[title='Delete All Logs']");
    _element = new core.ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_refreshButton(driver, root) {
    let _element = root;
    const _locator = core.By.css("lightning-button-icon[title='Refresh']");
    _element = new core.ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_autoRefreshToggle(driver, root) {
    let _element = root;
    const _locator = core.By.css("lightning-input[data-id='autorefresh-toggle']");
    _element = new core.ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_searchInput(driver, root) {
    let _element = root;
    const _locator = core.By.css("lightning-input[data-id='search-input']");
    _element = new core.ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_searchButton(driver, root) {
    let _element = root;
    const _locator = core.By.css("lightning-button-icon[title='Search']");
    _element = new core.ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_logTable(driver, root) {
    let _element = root;
    const _locator = core.By.css("c-log-table");
    _element = new core.ShadowRoot(driver, _element);
    return _element.findElement(_locator);
}
...
async function _utam_get_logView(driver, root) {
    let _element = root;
    const _locator = core.By.css("c-log-view");
    _element = new core.ShadowRoot(driver, _element);
    const hasElement = await _element.containsElement(_locator);
    if (!hasElement) { return null; }
    return _element.findElement(_locator);
...
async function _utam_get_logSearchResult(driver, root) {
    let _element = root;
    const _locator = core.By.css("c-log-search-result");
    _element = new core.ShadowRoot(driver, _element);
    const hasElement = await _element.containsElement(_locator);
    if (!hasElement) { return null; }
    return _element.findElement(_locator);
...
async function _utam_get_editLogFilter(driver, root) {
    let _element = root;
    const _locator = core.By.css("c-edit-log-filter");
    _element = new core.ShadowRoot(driver, _element);
    const hasElement = await _element.containsElement(_locator);
    if (!hasElement) { return null; }
    return _element.findElement(_locator);
 ...
 * @author UTAM
 */
class LogBoard extends core.UtamBasePageObject {
    ...
    async getLogTable() {
        ...
        element = await core.createInstance(_LogTable, driver, element);
    ...
    async getLogView() {
        ...
        if (!element) { return null; }
        element = await core.createInstance(_LogView, driver, element);
        await element.__beforeLoad__();
        return element;
    }
    ...
    async getLogSearchResult() {
        ...
        if (!element) { return null; }
        element = await core.createInstance(_LogSearchResult, driver, element);
        await element.__beforeLoad__();
        return element;
    }
    ...
    async getEditLogFilter() {
        ...
        if (!element) { return null; }
        element = await core.createInstance(_EditLogFilter, driver, element);
        await element.__beforeLoad__();
        return element;
    }
