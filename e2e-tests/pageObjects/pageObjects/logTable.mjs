...
async function _utam_get_table(driver, root) {
    let _element = root;
    const _locator = _By.css("table.table-dark");
...
async function _utam_get_firstRowViewButton(driver, root) {
    let _element = root;
    const _locator = _By.css("tbody tr:first-child lightning-button-icon[alternative-text='View']");
    _element = new _ShadowRoot(driver, _element);
...
async function _utam_get_firstRowDownloadButton(driver, root) {
    let _element = root;
    const _locator = _By.css("tbody tr:first-child lightning-button-icon[alternative-text='Download']");
    _element = new _ShadowRoot(driver, _element);
    const hasElement = await _element.containsElement(_locator);
    if (!hasElement) { return null; }
    return _element.findElement(_locator);
...
async function _utam_get_firstRowUser(driver, root) {
    let _element = root;
    const _locator = _By.css("tbody tr:first-child td:nth-child(3) .slds-truncate");
    _element = new _ShadowRoot(driver, _element);
    const hasElement = await _element.containsElement(_locator);
    if (!hasElement) { return null; }
    return _element.findElement(_locator);
...
async function _utam_get_firstRowOperation(driver, root) {
    let _element = root;
    const _locator = _By.css("tbody tr:first-child td:nth-child(4) .slds-truncate");
    _element = new _ShadowRoot(driver, _element);
    const hasElement = await _element.containsElement(_locator);
    if (!hasElement) { return null; }
    return _element.findElement(_locator);
...
async function _utam_get_firstRowStatus(driver, root) {
    let _element = root;
    const _locator = _By.css("tbody tr:first-child td:nth-child(5) .status");
    _element = new _ShadowRoot(driver, _element);
    const hasElement = await _element.containsElement(_locator);
    if (!hasElement) { return null; }
    return _element.findElement(_locator);
...
async function _utam_get_firstRowSize(driver, root) {
    let _element = root;
    const _locator = _By.css("tbody tr:first-child td:nth-child(6) .status");
    _element = new _ShadowRoot(driver, _element);
    const hasElement = await _element.containsElement(_locator);
    if (!hasElement) { return null; }
    return _element.findElement(_locator);
...
async function _utam_get_firstRowStartTime(driver, root) {
    let _element = root;
    const _locator = _By.css("tbody tr:first-child td:nth-child(7) .slds-truncate");
    _element = new _ShadowRoot(driver, _element);
    const hasElement = await _element.containsElement(_locator);
    if (!hasElement) { return null; }
    return _element.findElement(_locator);
